  ...
  return (
    <section className='space-y-15'>
      <div className="grid md:grid-cols-2">
        ...
        <div className="bg-accent text-white flex flex-col items-center justify-center px-10 lg:px-20 xl:px-32 2xl:px-46">
          <h1 className="md:text-[2rem] lg:text-5xl xl:text-6xl 2xl:text-9xl lg:mb-5 xl:mb-10 ">The Art Of Warmth And Light</h1>
          <p className="text-white/80 md:text-[0.6rem] lg:text-sm xl:text-lg 2xl:text-[1.9rem]">
